...
#define OUTFILE_HNC_NODE_CONNECT_CALLS        "../../data/hnc_node_gen_network_after3h.h"

// generate dictionary with connection information for import into NEST
#define OUTFILE_NEST_CONNECTIVITY_DICTS       "../../data/dictsConWeightDelayNEST_after3h.py"
