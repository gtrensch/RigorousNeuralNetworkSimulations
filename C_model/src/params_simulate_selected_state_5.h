...
#define OUTFILE_HNC_NODE_CONNECT_CALLS        "../../data/hnc_node_gen_network_after5h.h"

// generate dictionary with connection information for import into NEST
#define OUTFILE_NEST_CONNECTIVITY_DICTS       "../../data/dictsConWeightDelayNEST__after5h.py"
